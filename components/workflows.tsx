...
const DEFAULT_WORKFLOWS_CONTENT: WorkflowsContent = {
  sectionId: "services",
  eyebrow: "Offer",
...
export default function Workflows({ content }: WorkflowsProps) {
  const mergedContent = content ?? DEFAULT_WORKFLOWS_CONTENT;
  const benefits = mergedContent.benefits ?? DEFAULT_WORKFLOWS_CONTENT.benefits ?? [];
  ...
  return (
    <section id={mergedContent.sectionId ?? "services"} className="scroll-mt-20 mt-10">
            ...
            >
              <div className="grid gap-10 px-6 lg:grid-cols-[1fr_1.6fr] lg:items-start ">
                      ...
                      >
                        <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-[#ffe7bc]_after:absolute_after:inset-0_after:bg-linear-to-br_after:from-[#f4c74e]/20_after:via-transparent/40_after:to-[#f4c74e]/15">
                          ...
                          <Image
                            ...
                            src={mergedContent.image ?? WorflowImg03}
                            width={1200}
                            height={1500}
                            alt={mergedContent.imageAlt ?? "Workflow 03"}
                          />
                          {/* Content */}
                          <div className="p-0 md:p-0"></div>
                        </div>
                      </a>
                    </div>
                  </Spotlight>
                ...
                <ul className="space-y-3 text-sm text-[#5b4a2a] md:text-base">
                  <p
                    className="text-lg text-center  md:text-lg         bg-gradient-to-br
                from-amber-200
                via-amber-400
                via-amber-500
                to-amber-700
                ...
                drop-shadow-[0_2px_10px_rgba(245,158,11,0.35)]"
                  >
                    {mergedContent.listHeading}
                  </p>
                  {benefits.map((item, index) => (
                    <li key={index} className="flex items-start gap-3">
                      {/* Bullet */}
                      <div className="relative w-full rounded-xl border-2 border-amber-400 bg-[#ffffffb0] px-5 py-4 text-left min-h-[90%] ">
