  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Play icon */}
        <span className="pointer-events-none absolute p-2.5 before:absolute before:inset-0 before:rounded-full before:bg-[#dbeafe] before:duration-300 group-hover:before:scale-110">
