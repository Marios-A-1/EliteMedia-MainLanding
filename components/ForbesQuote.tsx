  ...
  return (
    <section className="mx-auto mt-4 max-w-3xl max-h-300 px-4">
      <a
        ...
        className="group block rounded-xl py-6  px-4 -pr-6 border-amber-300/60 bg-gradient-to-br from-amber-400/10 via-amber-200/40 to-amber-400/50 p-6 transition hover:shadow-lg"
      >
