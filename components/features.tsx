...
import FeaturesImage from "@/public/images/elite-media-logo-02.webp";

export default function Features() {
  return (
    <section id="how-it-works" className="relative scroll-mt-[80px]">
      <div
        ...
        <div className="border-t py-10 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-3 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-2xl font-semibold text-transparent md:text-4xl">
              Γιατί τα Social Media είναι σημαντικά</h2>
          ...
          {/* Items */}
          <div className="mx-auto grid max-w-none grid-cols-2 gap-6 sm:gap-8 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              <svg
              ...
              <h3 className="mb-1 font-nacelle text-sm font-semibold text-white md:text-[1rem]">
                Project Milestones
              </h3>
